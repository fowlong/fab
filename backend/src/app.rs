...
pub struct AppState {
    pub(crate) store: Arc<RwLock<HashMap<String, DocumentEntry>>>,
}
...
async fn apply_patch(
    ...
    crate::pdf::patch::apply_patches(&mut ir, &ops)?;
    entry.ir = ir;
...
mod tests {
    use super::*;
    use crate::types::{PatchOperation, PatchTarget, StylePayload};
    use axum::{
        body::{to_bytes, Body},

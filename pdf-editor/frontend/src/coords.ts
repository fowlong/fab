...
export function fabricDeltaToPdfDelta(initial: Matrix, current: number[] | Matrix, pageHeightPt: number): Matrix {
  ...
  const deltaFabric = multiply(currentMatrix, invert(initial));
